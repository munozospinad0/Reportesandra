...
(function(){
  ...
  function bgmPlay(){if(!bgm)return;var p=bgm.play();if(p&&p.catch)p.catch(function(){});var v=bgm.volume;var t=setInterval(function(){v=Math.min(0.056,v+0.007);bgm.volume=v;if(v>=0.056)clearInterval(t);},90);}
