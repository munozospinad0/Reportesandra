...
(function(){
  ...
  function bgmPlay(){if(!bgm)return;var p=bgm.play();if(p&&p.catch)p.catch(function(){});var v=bgm.volume;var t=setInterval(function(){v=Math.min(0.05,v+0.006);bgm.volume=v;if(v>=0.05)clearInterval(t);},90);}
